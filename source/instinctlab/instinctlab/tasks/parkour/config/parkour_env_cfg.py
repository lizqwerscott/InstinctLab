...
ROUGH_TERRAINS_CFG = TerrainGeneratorCfg(
    ...
    sub_terrains={
        ...
        "updownwithwalls": terrain_gen.PerlinStairsUpDownWithWallsTerrainCfg(
            proportion=0.15,
...
class CommandsCfg:
    ...
    base_velocity = mdp.PoseVelocityCommandCfg(
        ...
        velocity_ranges={
            ...
            "updownwithwalls": {"lin_vel_x": (0.45, 0.8), "lin_vel_y": (0.0, 0.0), "ang_vel_z": (-1.0, 1.0)},
        },
