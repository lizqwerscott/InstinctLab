...
class CommandsCfg:
    ...
    base_velocity = mdp.PoseVelocityCommandCfg(
        ...
        velocity_ranges={
            ...
            "pyramid_stairs": {"lin_vel_x": (0.48, 0.55), "lin_vel_y": (0.0, 0.0), "ang_vel_z": (-1.0, 1.0)},
            "pyramid_stairs_inv": {"lin_vel_x": (0.48, 0.55), "lin_vel_y": (0.0, 0.0), "ang_vel_z": (-1.0, 1.0)},
            "up_down": {"lin_vel_x": (0.48, 0.55), "lin_vel_y": (0.0, 0.0), "ang_vel_z": (-1.0, 1.0)},
            "down_up": {"lin_vel_x": (0.48, 0.55), "lin_vel_y": (0.0, 0.0), "ang_vel_z": (-1.0, 1.0)},
        },
