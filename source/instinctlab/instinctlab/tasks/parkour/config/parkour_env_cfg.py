...
class CommandsCfg:
    ...
    base_velocity = mdp.PoseVelocityCommandCfg(
        ...
        velocity_ranges={
            ...
            "pyramid_stairs": {"lin_vel_x": (0.45, 0.6), "lin_vel_y": (0.0, 0.0), "ang_vel_z": (-1.0, 1.0)},
            "pyramid_stairs_tiny": {"lin_vel_x": (0.45, 0.6), "lin_vel_y": (0.0, 0.0), "ang_vel_z": (-1.0, 1.0)},
            "pyramid_stairs_inv": {"lin_vel_x": (0.45, 0.6), "lin_vel_y": (0.0, 0.0), "ang_vel_z": (-1.0, 1.0)},
            "pyramid_stairs_inv_tiny": {"lin_vel_x": (0.45, 0.6), "lin_vel_y": (0.0, 0.0), "ang_vel_z": (-1.0, 1.0)},
        },
