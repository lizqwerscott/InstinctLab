...
class AmassMotionCfg(AmassMotionCfgBase):
    ...
    #
    # Block layout of parkour_motion_amp_curated_retargetted.npz
    # (built by scripts/motion_reference/npz_motion_tool.py from parkour_motion_curated.yaml;
    # each stair block is walk ~2s -> stairs ~5-6s -> walk ~2s -> stand ~11s):
    #   up_normal    0- 21  stairs up   ~0.55 m/s  (z 0.8 -> 2.7)
    #   up_fast     21- 42  stairs up   ~0.65 m/s
    #   down_normal 42- 63  stairs down ~0.55 m/s  (z 2.8 -> 0.8)
    #   down_fast   63- 84  stairs down ~0.69 m/s
    #   WALK+TURN   84-151 | STAND/TURN-IN-PLACE 151-176
    #
    ...
    # Terrain semantics (instinctlab hf_terrains): pyramid_stairs_inv is a pit — the robot
    # spawns on the low center platform and climbs UP; pyramid_stairs spawns on the high
    # center platform and walks DOWN.
    subterrain_start_times_s = {
        "pyramid_stairs_inv":      [0.0, 21.0],     # up_normal / up_fast
        "pyramid_stairs":          [42.0, 63.0],    # down_normal / down_fast
    }
